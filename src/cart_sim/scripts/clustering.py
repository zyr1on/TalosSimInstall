...
def split_cloud(cloud):
  ...
  downsampled_cloud = do_voxel_grid_filter(point_cloud = cloud, LEAF_SIZE = 0.00001)
  ...
  filtered_cloud = do_passthrough_filter(point_cloud = downsampled_cloud, 
                                         name_axis = 'z', min_axis = 0.1, max_axis = 1.1)
...
if __name__ == '__main__':
  ...
  # Create Subscribers
  subscriber = rospy.Subscriber("/my_filtered_cloud", pc2.PointCloud2, pcl_callback, queue_size = 1)
